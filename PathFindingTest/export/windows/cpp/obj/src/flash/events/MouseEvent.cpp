...
::flash::events::Event MouseEvent_obj::clone( ){
	...
	HX_STACK_LINE(67)
	return ::flash::events::MouseEvent_obj::__new(_g,_g1,this->get_cancelable(),this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
}
