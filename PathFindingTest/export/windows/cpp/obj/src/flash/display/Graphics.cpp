	...
	HX_STACK_ARG(focalPointRatio,"focalPointRatio")
{
		...
		HX_STACK_LINE(61)
		::flash::display::Graphics_obj::lime_gfx_begin_gradient_fill(this->__handle,_g,colors,alphas,ratios,matrix,_g1,(  (((interpolationMethod == null()))) ? int((int)0) : int(interpolationMethod->__Index()) ),focalPointRatio);
	}
return null();
}
	...
	HX_STACK_ARG(focalPointRatio,"focalPointRatio")
{
		...
		HX_STACK_LINE(190)
		::flash::display::Graphics_obj::lime_gfx_line_gradient_fill(this->__handle,_g,colors,alphas,ratios,matrix,_g1,(  (((interpolationMethod == null()))) ? int((int)0) : int(interpolationMethod->__Index()) ),focalPointRatio);
	}
return null();
}
	...
	HX_STACK_ARG(miterLimit,"miterLimit")
{
		...
		HX_STACK_LINE(197)
		::flash::display::Graphics_obj::lime_gfx_line_style(this->__handle,thickness,color,alpha,pixelHinting,_g,_g1,(  (((joints == null()))) ? int((int)0) : int(joints->__Index()) ),miterLimit);
	}
return null();
}
