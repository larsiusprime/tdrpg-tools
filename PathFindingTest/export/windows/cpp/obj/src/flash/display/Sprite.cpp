...
bool lockCenter = __o_lockCenter.Default(false);
	HX_STACK_FRAME("flash.display.Sprite","startDrag",0xe030b617,"flash.display.Sprite.startDrag","flash/display/Sprite.hx",23,0x9c3a670d)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flash.display.Sprite","stopDrag",0x2a480f95,"flash.display.Sprite.stopDrag","flash/display/Sprite.hx",34,0x9c3a670d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(34)
		if (((this->get_stage() != null()))){
			HX_STACK_LINE(36)
