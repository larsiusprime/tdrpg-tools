...
Void URLVariables_obj::decode( ::String data){
{
		...
		HX_STACK_LINE(30)
		{
			...
			while(((_g < fields1->length))){
				...
				if (((index > (int)0))){
					HX_STACK_LINE(36)
					::String field1;		HX_STACK_VAR(field1,"field1");
					HX_STACK_LINE(36)
					{
						HX_STACK_LINE(36)
						::String s = field.substr((int)0,index);		HX_STACK_VAR(s,"s");
						HX_STACK_LINE(36)
						field1 = s.__URLDecode();
					}
					HX_STACK_LINE(36)
					...
					{
						HX_STACK_LINE(36)
						::String s = field.substr((index + (int)1),null());		HX_STACK_VAR(s,"s");
						HX_STACK_LINE(36)
						value = s.__URLDecode();
					}
					HX_STACK_LINE(36)
					...
					if (((index != (int)0))){
						HX_STACK_LINE(40)
						::String field1 = field.__URLDecode();		HX_STACK_VAR(field1,"field1");
						HX_STACK_LINE(40)
...
::String URLVariables_obj::toString( ){
	...
	HX_STACK_LINE(54)
	{
		...
		while(((_g < fields->length))){
			...
			++(_g);
			HX_STACK_LINE(56)
			::String _g1 = (field.__URLEncode() + HX_CSTRING("="));		HX_STACK_VAR(_g1,"_g1");
			struct _Function_3_1{
				inline static ::String Block( ::flash::net::URLVariables_obj *__this,::String &field){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flash/net/URLVariables.hx",56,0xa6ec0845)
					{
						HX_STACK_LINE(56)
						::String s = ::Reflect_obj::field(__this,field);		HX_STACK_VAR(s,"s");
						HX_STACK_LINE(56)
			...
			HX_STACK_LINE(56)
			result->push((_g1 + _Function_3_1::Block(this,field)));
		}
	}
	HX_STACK_LINE(60)
