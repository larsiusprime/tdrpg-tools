...
bool ApplicationDomain_obj::hasDefinition( ::String name){
	HX_STACK_FRAME("flash.system.ApplicationDomain","hasDefinition",0xc14e99b2,"flash.system.ApplicationDomain.hasDefinition","flash/system/ApplicationDomain.hx",36,0xa20b04eb)
	HX_STACK_THIS(this)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(36)
