	...
	if (((this->position < this->length))){
		struct _Function_2_1{
			inline static int Block( ::flash::utils::ByteArray_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flash/utils/ByteArray.hx",225,0xfb64f02a)
				{
					HX_STACK_LINE(225)
...
{
		HX_STACK_FRAME("flash.utils.ByteArray","write_uncheck",0x36cf58d7,"flash.utils.ByteArray.write_uncheck","flash/utils/ByteArray.hx",532,0xfb64f02a)
		HX_STACK_THIS(this)
