...
Void Mouse_obj::hide( ){
{
		HX_STACK_FRAME("flash.ui.Mouse","hide",0xa303c867,"flash.ui.Mouse.hide","flash/ui/Mouse.hx",12,0x813e2215)
		HX_STACK_LINE(12)
...
Void Mouse_obj::show( ){
{
		HX_STACK_FRAME("flash.ui.Mouse","show",0xaa4868a2,"flash.ui.Mouse.show","flash/ui/Mouse.hx",23,0x813e2215)
		HX_STACK_LINE(23)
		if (((::flash::Lib_obj::get_stage() != null()))){
			HX_STACK_LINE(25)
