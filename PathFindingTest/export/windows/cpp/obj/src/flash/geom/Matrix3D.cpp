...
{
		HX_STACK_FRAME("flash.geom.Matrix3D","appendScale",0xa168e7e8,"flash.geom.Matrix3D.appendScale","flash/geom/Matrix3D.hx",82,0x1a66ac18)
		HX_STACK_THIS(this)
...
::flash::geom::Matrix3D Matrix3D_obj::clone( ){
	HX_STACK_FRAME("flash.geom.Matrix3D","clone",0xc5eed2f5,"flash.geom.Matrix3D.clone","flash/geom/Matrix3D.hx",98,0x1a66ac18)
	HX_STACK_THIS(this)
	HX_STACK_LINE(98)
...
{
		HX_STACK_FRAME("flash.geom.Matrix3D","prependScale",0x77853804,"flash.geom.Matrix3D.prependScale","flash/geom/Matrix3D.hx",542,0x1a66ac18)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xScale,"xScale")
		HX_STACK_ARG(yScale,"yScale")
		HX_STACK_ARG(zScale,"zScale")
...
bool Matrix3D_obj::recompose( Array< ::Dynamic > components){
	...
	HX_STACK_LINE(565)
	this->append(::flash::geom::Matrix3D_obj::__new(Array_obj< Float >::__new().Add((int)1).Add((int)0).Add((int)0).Add((int)0).Add((int)0).Add(_g).Add(-(_g1)).Add((int)0).Add((int)0).Add(_g2).Add(::Math_obj::cos(angle)).Add((int)0).Add((int)0).Add((int)0).Add((int)0).Add((int)0)));
	HX_STACK_LINE(566)
	angle = -(components->__get((int)1).StaticCast< ::flash::geom::Vector3D >()->y);
	HX_STACK_LINE(567)
	Float _g3 = ::Math_obj::cos(angle);		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(567)
	Float _g4 = ::Math_obj::sin(angle);		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(567)
	Float _g5 = ::Math_obj::sin(angle);		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(567)
	this->append(::flash::geom::Matrix3D_obj::__new(Array_obj< Float >::__new().Add(_g3).Add((int)0).Add(_g4).Add((int)0).Add((int)0).Add((int)1).Add((int)0).Add((int)0).Add(-(_g5)).Add((int)0).Add(::Math_obj::cos(angle)).Add((int)0).Add((int)0).Add((int)0).Add((int)0).Add((int)0)));
	HX_STACK_LINE(568)
	...
	HX_STACK_LINE(569)
	this->append(::flash::geom::Matrix3D_obj::__new(Array_obj< Float >::__new().Add(_g6).Add(-(_g7)).Add((int)0).Add((int)0).Add(_g8).Add(::Math_obj::cos(angle)).Add((int)0).Add((int)0).Add((int)0).Add((int)0).Add((int)1).Add((int)0).Add((int)0).Add((int)0).Add((int)0).Add((int)0)));
	HX_STACK_LINE(571)
