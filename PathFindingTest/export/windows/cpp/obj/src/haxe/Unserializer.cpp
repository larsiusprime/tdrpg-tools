...
Dynamic Unserializer_obj::unserializeEnum( ::Enum edecl,::String tag){
	...
	struct _Function_1_1{
		inline static int Block( ::haxe::Unserializer_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",188,0x00b9ec83)
			{
				HX_STACK_LINE(188)
		...
		switch( (int)(_g)){
			...
			case (int)121: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",244,0x00b9ec83)
						{
							HX_STACK_LINE(244)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(244)
			...
			case (int)115: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",371,0x00b9ec83)
						{
							HX_STACK_LINE(371)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(371)
				...
				while(((i < max))){
					struct _Function_4_1{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",388,0x00b9ec83)
							{
								HX_STACK_LINE(388)
					...
					struct _Function_4_2{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",389,0x00b9ec83)
							{
								HX_STACK_LINE(389)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(389)
					...
					struct _Function_4_3{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",391,0x00b9ec83)
							{
								HX_STACK_LINE(391)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(391)
					...
					struct _Function_4_4{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",393,0x00b9ec83)
							{
								HX_STACK_LINE(393)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(393)
				...
				if (((rest >= (int)2))){
					struct _Function_4_1{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",397,0x00b9ec83)
							{
								HX_STACK_LINE(397)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(397)
					...
					struct _Function_4_2{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",398,0x00b9ec83)
							{
								HX_STACK_LINE(398)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(398)
					...
					if (((rest == (int)3))){
						struct _Function_5_1{
							inline static int Block( int &i,::String &buf){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",401,0x00b9ec83)
								{
									HX_STACK_LINE(401)
									int index = (i)++;		HX_STACK_VAR(index,"index");
									HX_STACK_LINE(401)
			...
			case (int)67: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",417,0x00b9ec83)
						{
							HX_STACK_LINE(417)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(417)
