...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("HaxeFlixel"),HX_CSTRING("PathFindingTest"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
		HX_STACK_LINE(113)
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(_g))) | int(_g1))) | int(_g2))) | int(_g3))) | int(_g4))) | int(_g5))) | int(_g6))) | int(_g7))) | int(_g8))) | int(_g9)),HX_CSTRING("PathFindingTest"),null(),null());
	}
return null();
}
