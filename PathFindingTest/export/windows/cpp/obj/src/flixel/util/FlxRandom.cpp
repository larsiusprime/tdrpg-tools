...
int EndIndex = __o_EndIndex.Default(0);
	HX_STACK_FRAME("flixel.util.FlxRandom","getObject_getRandom_T",0xe7f9d7b1,"flixel.util.FlxRandom.getObject_getRandom_T","flixel/util/FlxRandom.hx",288,0xd3ba8ba3)
...
Dynamic FlxRandom_obj::shuffleArray_shuffle_T( Dynamic Objects,int HowManyTimes){
	HX_STACK_FRAME("flixel.util.FlxRandom","shuffleArray_shuffle_T",0x26b19da2,"flixel.util.FlxRandom.shuffleArray_shuffle_T","flixel/util/FlxRandom.hx",326,0xd3ba8ba3)
	HX_STACK_ARG(Objects,"Objects")
...
bool GreyScale = __o_GreyScale.Default(false);
	HX_STACK_FRAME("flixel.util.FlxRandom","color",0x296f0f10,"flixel.util.FlxRandom.color","flixel/util/FlxRandom.hx",400,0xd3ba8ba3)
	HX_STACK_ARG(Min,"Min")
	HX_STACK_ARG(Max,"Max")
...
int AlphaMaximum = __o_AlphaMaximum.Default(-1);
	HX_STACK_FRAME("flixel.util.FlxRandom","colorExt",0x1aec7f71,"flixel.util.FlxRandom.colorExt","flixel/util/FlxRandom.hx",461,0xd3ba8ba3)
...
int FlxRandom_obj::generate( ){
	HX_STACK_FRAME("flixel.util.FlxRandom","generate",0x6aa9cba8,"flixel.util.FlxRandom.generate","flixel/util/FlxRandom.hx",497,0xd3ba8ba3)
	HX_STACK_LINE(497)
	return ::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647));
}
