...
{
		HX_STACK_FRAME("flixel.util.loaders.TextureAtlasFrame","destroy",0xbd50d681,"flixel.util.loaders.TextureAtlasFrame.destroy","flixel/util/loaders/TextureAtlasFrame.hx",20,0x8cfab1ca)
		HX_STACK_THIS(this)
		HX_STACK_LINE(21)
		this->name = null();
		HX_STACK_LINE(22)
