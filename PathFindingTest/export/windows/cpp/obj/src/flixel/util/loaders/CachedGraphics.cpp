...
{
		HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","dump",0x589cb7cd,"flixel.util.loaders.CachedGraphics.dump","flixel/util/loaders/CachedGraphics.hx",74,0x7a61d3e8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","undump",0x016856e6,"flixel.util.loaders.CachedGraphics.undump","flixel/util/loaders/CachedGraphics.hx",88,0x7a61d3e8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(88)
		if ((this->isDumped)){
			HX_STACK_LINE(90)
...
{
		HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","onContext",0x22400957,"flixel.util.loaders.CachedGraphics.onContext","flixel/util/loaders/CachedGraphics.hx",114,0x7a61d3e8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(114)
		if ((this->isDumped)){
			HX_STACK_LINE(116)
...
::flixel::util::loaders::TextureRegion CachedGraphics_obj::getRegionForFrame( ::String FrameName){
	HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","getRegionForFrame",0x4be29a75,"flixel.util.loaders.CachedGraphics.getRegionForFrame","flixel/util/loaders/CachedGraphics.hx",122,0x7a61d3e8)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","destroy",0x801dd801,"flixel.util.loaders.CachedGraphics.destroy","flixel/util/loaders/CachedGraphics.hx",138,0x7a61d3e8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(139)
		if (((this->bitmap != null()))){
			HX_STACK_LINE(141)
...
::flixel::system::layer::TileSheetData CachedGraphics_obj::get_tilesheet( ){
	HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","get_tilesheet",0xd5f1cecf,"flixel.util.loaders.CachedGraphics.get_tilesheet","flixel/util/loaders/CachedGraphics.hx",153,0x7a61d3e8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(154)
	if (((this->_tilesheet == null()))){
		HX_STACK_LINE(156)
...
::flash::display::BitmapData CachedGraphics_obj::getBitmapFromSystem( ){
	HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","getBitmapFromSystem",0xd5289305,"flixel.util.loaders.CachedGraphics.getBitmapFromSystem","flixel/util/loaders/CachedGraphics.hx",168,0x7a61d3e8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(169)
...
bool CachedGraphics_obj::get_canBeDumped( ){
	HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","get_canBeDumped",0x64ad8a84,"flixel.util.loaders.CachedGraphics.get_canBeDumped","flixel/util/loaders/CachedGraphics.hx",184,0x7a61d3e8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(184)
...
int CachedGraphics_obj::set_useCount( int Value){
	HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","set_useCount",0xf01d7a1e,"flixel.util.loaders.CachedGraphics.set_useCount","flixel/util/loaders/CachedGraphics.hx",188,0x7a61d3e8)
	HX_STACK_THIS(this)
...
bool CachedGraphics_obj::set_destroyOnNoUse( bool Value){
	HX_STACK_FRAME("flixel.util.loaders.CachedGraphics","set_destroyOnNoUse",0xf2e436a3,"flixel.util.loaders.CachedGraphics.set_destroyOnNoUse","flixel/util/loaders/CachedGraphics.hx",198,0x7a61d3e8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(199)
