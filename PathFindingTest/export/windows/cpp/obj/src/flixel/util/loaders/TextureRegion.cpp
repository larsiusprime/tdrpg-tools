...
{
HX_STACK_FRAME("flixel.util.loaders.TextureRegion","new",0x14240bf9,"flixel.util.loaders.TextureRegion.new","flixel/util/loaders/TextureRegion.hx",12,0xdc04a3f8)
...
{
		HX_STACK_FRAME("flixel.util.loaders.TextureRegion","destroy",0x1cdea913,"flixel.util.loaders.TextureRegion.destroy","flixel/util/loaders/TextureRegion.hx",27,0xdc04a3f8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(28)
		this->data = null();
		HX_STACK_LINE(29)
