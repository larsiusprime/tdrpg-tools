	...
	HX_STACK_ARG(Camera,"Camera")
{
		...
		if ((considerRotation)){
			...
			HX_STACK_LINE(128)
			::flash::display::BitmapData testA2 = ::flixel::util::FlxBitmapDataPool_obj::get(_g,::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->height),true,(int)0,false);		HX_STACK_VAR(testA2,"testA2");
			HX_STACK_LINE(131)
			...
			HX_STACK_LINE(140)
			::flash::display::BitmapData testB2 = ::flixel::util::FlxBitmapDataPool_obj::get(_g1,::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->height),true,(int)0,false);		HX_STACK_VAR(testB2,"testB2");
			HX_STACK_LINE(141)
...
int AlphaTolerance = __o_AlphaTolerance.Default(1);
	HX_STACK_FRAME("flixel.util.FlxCollision","pixelPerfectPointCheck",0x29896333,"flixel.util.FlxCollision.pixelPerfectPointCheck","flixel/util/FlxCollision.hx",213,0x8c8a7b84)
