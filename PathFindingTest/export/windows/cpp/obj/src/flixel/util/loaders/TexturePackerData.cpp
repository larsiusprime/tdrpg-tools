...
{
		HX_STACK_FRAME("flixel.util.loaders.TexturePackerData","destroy",0x67aefe6f,"flixel.util.loaders.TexturePackerData.destroy","flixel/util/loaders/TexturePackerData.hx",77,0x94e9909c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(78)
		{
			HX_STACK_LINE(78)
