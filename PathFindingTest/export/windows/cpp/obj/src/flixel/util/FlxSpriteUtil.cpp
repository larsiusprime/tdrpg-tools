...
::flixel::FlxSprite FlxSpriteUtil_obj::alphaMask( ::flixel::FlxSprite output,Dynamic source,Dynamic mask){
	...
	if ((::Std_obj::is(source,hx::ClassOf< ::String >()))){
		...
		HX_STACK_LINE(56)
		data = ::openfl::Assets_obj::getBitmapData(id,false);
	}
	else{
		HX_STACK_LINE(58)
	...
	if ((::Std_obj::is(mask,hx::ClassOf< ::String >()))){
		...
		HX_STACK_LINE(73)
		maskData = ::openfl::Assets_obj::getBitmapData(id,false);
	}
	else{
		HX_STACK_LINE(75)
	...
	HX_STACK_LINE(88)
	::flash::geom::Rectangle _g1 = ::flash::geom::Rectangle_obj::__new((int)0,(int)0,_g,data->get_height());		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(88)
	data->copyChannel(maskData,_g1,::flash::geom::Point_obj::__new(null(),null()),(int)8,(int)8);
	HX_STACK_LINE(89)
...
::flixel::FlxSprite FlxSpriteUtil_obj::alphaMaskFlxSprite( ::flixel::FlxSprite sprite,::flixel::FlxSprite mask,::flixel::FlxSprite output){
	...
	HX_STACK_LINE(109)
	::flash::geom::Rectangle _g2 = ::flash::geom::Rectangle_obj::__new((int)0,(int)0,_g1,sprite->get_height());		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(109)
	data->copyChannel(_g,_g2,::flash::geom::Point_obj::__new(null(),null()),(int)8,(int)8);
	HX_STACK_LINE(110)
	output->set_pixels(data);
	HX_STACK_LINE(111)
	return output;
...
bool spaceFromBounds = __o_spaceFromBounds.Default(false);
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","space",0x47f36e17,"flixel.util.FlxSpriteUtil.space","flixel/util/FlxSpriteUtil.hx",154,0xc647097f)
...
bool yAxis = __o_yAxis.Default(true);
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","screenCenter",0xb5308930,"flixel.util.FlxSpriteUtil.screenCenter","flixel/util/FlxSpriteUtil.hx",184,0xc647097f)
...
::flixel::FlxSprite FlxSpriteUtil_obj::drawLine( ::flixel::FlxSprite sprite,Float StartX,Float StartY,Float EndX,Float EndY,Dynamic lineStyle,Dynamic drawStyle){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","drawLine",0x239cc967,"flixel.util.FlxSpriteUtil.drawLine","flixel/util/FlxSpriteUtil.hx",214,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(StartX,"StartX")
	HX_STACK_ARG(StartY,"StartY")
	...
	HX_STACK_LINE(215)
	{
		...
		struct _Function_2_1{
			inline static Float Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",215,0xc647097f)
				{
					HX_STACK_LINE(215)
...
::flixel::FlxSprite FlxSpriteUtil_obj::drawRect( ::flixel::FlxSprite sprite,Float X,Float Y,Float Width,Float Height,int Color,Dynamic lineStyle,Dynamic fillStyle,Dynamic drawStyle){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","drawRect",0x2790fe97,"flixel.util.FlxSpriteUtil.drawRect","flixel/util/FlxSpriteUtil.hx",237,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
		...
		if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
			...
			struct _Function_3_1{
				inline static Float Block( Dynamic &fillStyle){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",238,0xc647097f)
					{
						HX_STACK_LINE(238)
						int Color1 = fillStyle->__Field(HX_CSTRING("color"),true);		HX_STACK_VAR(Color1,"Color1");
						HX_STACK_LINE(238)
...
::flixel::FlxSprite FlxSpriteUtil_obj::drawRoundRect( ::flixel::FlxSprite sprite,Float X,Float Y,Float Width,Float Height,Float EllipseWidth,Float EllipseHeight,int Color,Dynamic lineStyle,Dynamic fillStyle,Dynamic drawStyle){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","drawRoundRect",0x00e2de3f,"flixel.util.FlxSpriteUtil.drawRoundRect","flixel/util/FlxSpriteUtil.hx",261,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
	HX_STACK_ARG(Width,"Width")
	...
	HX_STACK_LINE(262)
	{
		...
		if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
			...
			struct _Function_3_1{
				inline static Float Block( Dynamic &fillStyle){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",262,0xc647097f)
					{
						HX_STACK_LINE(262)
						int Color1 = fillStyle->__Field(HX_CSTRING("color"),true);		HX_STACK_VAR(Color1,"Color1");
						HX_STACK_LINE(262)
...
int Color = __o_Color.Default(-1);
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","drawCircle",0x44dca643,"flixel.util.FlxSpriteUtil.drawCircle","flixel/util/FlxSpriteUtil.hx",311,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
	...
	HX_STACK_ARG(drawStyle,"drawStyle")
{
		...
		HX_STACK_LINE(330)
		{
			...
			if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
				...
				struct _Function_3_1{
					inline static Float Block( Dynamic &fillStyle){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",330,0xc647097f)
						{
							HX_STACK_LINE(330)
							int Color1 = fillStyle->__Field(HX_CSTRING("color"),true);		HX_STACK_VAR(Color1,"Color1");
							HX_STACK_LINE(330)
...
::flixel::FlxSprite FlxSpriteUtil_obj::drawEllipse( ::flixel::FlxSprite sprite,Float X,Float Y,Float Width,Float Height,int Color,Dynamic lineStyle,Dynamic fillStyle,Dynamic drawStyle){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","drawEllipse",0x1204b94b,"flixel.util.FlxSpriteUtil.drawEllipse","flixel/util/FlxSpriteUtil.hx",351,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
	HX_STACK_ARG(Width,"Width")
	...
	HX_STACK_LINE(352)
	{
		...
		if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
			...
			struct _Function_3_1{
				inline static Float Block( Dynamic &fillStyle){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",352,0xc647097f)
					{
						HX_STACK_LINE(352)
						int Color1 = fillStyle->__Field(HX_CSTRING("color"),true);		HX_STACK_VAR(Color1,"Color1");
						HX_STACK_LINE(352)
...
::flixel::FlxSprite FlxSpriteUtil_obj::drawTriangle( ::flixel::FlxSprite sprite,Float X,Float Y,Float Height,int Color,Dynamic lineStyle,Dynamic fillStyle,Dynamic drawStyle){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","drawTriangle",0x35f0a5bb,"flixel.util.FlxSpriteUtil.drawTriangle","flixel/util/FlxSpriteUtil.hx",372,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
	HX_STACK_ARG(Height,"Height")
	...
	HX_STACK_LINE(373)
	{
		...
		if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
			...
			struct _Function_3_1{
				inline static Float Block( Dynamic &fillStyle){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",373,0xc647097f)
					{
						HX_STACK_LINE(373)
						int Color1 = fillStyle->__Field(HX_CSTRING("color"),true);		HX_STACK_VAR(Color1,"Color1");
						HX_STACK_LINE(373)
...
::flixel::FlxSprite FlxSpriteUtil_obj::drawPolygon( ::flixel::FlxSprite sprite,Array< ::Dynamic > Vertices,int Color,Dynamic lineStyle,Dynamic fillStyle,Dynamic drawStyle){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","drawPolygon",0x190f7ae7,"flixel.util.FlxSpriteUtil.drawPolygon","flixel/util/FlxSpriteUtil.hx",394,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	...
	HX_STACK_LINE(395)
	{
		...
		if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
			...
			struct _Function_3_1{
				inline static Float Block( Dynamic &fillStyle){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",395,0xc647097f)
					{
						HX_STACK_LINE(395)
						int Color1 = fillStyle->__Field(HX_CSTRING("color"),true);		HX_STACK_VAR(Color1,"Color1");
						HX_STACK_LINE(395)
...
{
		HX_STACK_FRAME("flixel.util.FlxSpriteUtil","beginDraw",0x53d0689e,"flixel.util.FlxSpriteUtil.beginDraw","flixel/util/FlxSpriteUtil.hx",414,0xc647097f)
		HX_STACK_ARG(Color,"Color")
		HX_STACK_ARG(lineStyle,"lineStyle")
		HX_STACK_ARG(fillStyle,"fillStyle")
		HX_STACK_LINE(415)
		...
		if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
			...
			struct _Function_2_1{
				inline static Float Block( Dynamic &fillStyle){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",421,0xc647097f)
					{
						HX_STACK_LINE(421)
						int Color1 = fillStyle->__Field(HX_CSTRING("color"),true);		HX_STACK_VAR(Color1,"Color1");
						HX_STACK_LINE(421)
			...
			struct _Function_2_1{
				inline static Float Block( int &Color){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",426,0xc647097f)
					{
						HX_STACK_LINE(426)
						int f = (int((int(Color) >> int((int)24))) & int((int)255));		HX_STACK_VAR(f,"f");
						HX_STACK_LINE(426)
...
::flixel::FlxSprite FlxSpriteUtil_obj::endDraw( ::flixel::FlxSprite sprite,Dynamic drawStyle){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","endDraw",0x51197d10,"flixel.util.FlxSpriteUtil.endDraw","flixel/util/FlxSpriteUtil.hx",438,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(drawStyle,"drawStyle")
	HX_STACK_LINE(439)
	::flixel::util::FlxSpriteUtil_obj::flashGfx->endFill();
...
::flixel::FlxSprite FlxSpriteUtil_obj::updateSpriteGraphic( ::flixel::FlxSprite sprite,Dynamic drawStyle){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","updateSpriteGraphic",0x448b866b,"flixel.util.FlxSpriteUtil.updateSpriteGraphic","flixel/util/FlxSpriteUtil.hx",453,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(drawStyle,"drawStyle")
	HX_STACK_LINE(454)
	if (((drawStyle == null()))){
		struct _Function_2_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",456,0xc647097f)
				{
...
{
		HX_STACK_FRAME("flixel.util.FlxSpriteUtil","setLineStyle",0xc19fc36a,"flixel.util.FlxSpriteUtil.setLineStyle","flixel/util/FlxSpriteUtil.hx",478,0xc647097f)
		HX_STACK_ARG(lineStyle,"lineStyle")
		HX_STACK_LINE(478)
		if (((lineStyle != null()))){
			HX_STACK_LINE(480)
...
::flixel::FlxSprite FlxSpriteUtil_obj::fill( ::flixel::FlxSprite sprite,int Color){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","fill",0x7a944252,"flixel.util.FlxSpriteUtil.fill","flixel/util/FlxSpriteUtil.hx",516,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(517)
...
bool ForceRestart = __o_ForceRestart.Default(true);
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","flicker",0xa3717289,"flixel.util.FlxSpriteUtil.flicker","flixel/util/FlxSpriteUtil.hx",541,0xc647097f)
	HX_STACK_ARG(Object,"Object")
...
bool FlxSpriteUtil_obj::isFlickering( ::flixel::FlxObject Object){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","isFlickering",0x05aae043,"flixel.util.FlxSpriteUtil.isFlickering","flixel/util/FlxSpriteUtil.hx",553,0xc647097f)
	HX_STACK_ARG(Object,"Object")
	HX_STACK_LINE(553)
...
::flixel::FlxObject FlxSpriteUtil_obj::stopFlickering( ::flixel::FlxObject Object){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","stopFlickering",0x9d49141b,"flixel.util.FlxSpriteUtil.stopFlickering","flixel/util/FlxSpriteUtil.hx",563,0xc647097f)
	HX_STACK_ARG(Object,"Object")
	HX_STACK_LINE(564)
...
::flixel::FlxSprite FlxSpriteUtil_obj::fadeIn( ::flixel::FlxSprite sprite,Float Duration,Dynamic ResetAlpha,Dynamic OnComplete){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","fadeIn",0xd9639210,"flixel.util.FlxSpriteUtil.fadeIn","flixel/util/FlxSpriteUtil.hx",576,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(Duration,"Duration")
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &OnComplete){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",580,0xc647097f)
			{
				hx::Anon __result = hx::Anon_obj::Create();
...
::flixel::FlxSprite FlxSpriteUtil_obj::fadeOut( ::flixel::FlxSprite sprite,Float Duration,Dynamic FadeToBlack,Dynamic OnComplete){
	HX_STACK_FRAME("flixel.util.FlxSpriteUtil","fadeOut",0x5dc0d003,"flixel.util.FlxSpriteUtil.fadeOut","flixel/util/FlxSpriteUtil.hx",592,0xc647097f)
	HX_STACK_ARG(sprite,"sprite")
	HX_STACK_ARG(Duration,"Duration")
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &OnComplete){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxSpriteUtil.hx",593,0xc647097f)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("complete") , OnComplete,false);
				return __result;
