...
{
HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadButton","new",0xa97275d6,"flixel.input.gamepad.FlxGamepadButton.new","flixel/input/gamepad/FlxGamepadButton.hx",10,0xa176f377)
...
{
		HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadButton","reset",0x10f3b8c5,"flixel.input.gamepad.FlxGamepadButton.reset","flixel/input/gamepad/FlxGamepadButton.hx",17,0xa176f377)
		HX_STACK_THIS(this)
		HX_STACK_LINE(18)
		this->current = (int)0;
		HX_STACK_LINE(19)
