...
{
		HX_STACK_FRAME("flixel.FlxSubState","destroy",0xc08a1d5d,"flixel.FlxSubState.destroy","flixel/FlxSubState.hx",70,0xd8a3e54e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(71)
		this->super::destroy();
		HX_STACK_LINE(72)
...
int FlxSubState_obj::set_bgColor( int Value){
	HX_STACK_FRAME("flixel.FlxSubState","set_bgColor",0x0d524664,"flixel.FlxSubState.set_bgColor","flixel/FlxSubState.hx",96,0xd8a3e54e)
	HX_STACK_THIS(this)
