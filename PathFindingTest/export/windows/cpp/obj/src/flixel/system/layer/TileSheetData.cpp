...
{
HX_STACK_FRAME("flixel.system.layer.TileSheetData","new",0xa6b56f23,"flixel.system.layer.TileSheetData.new","flixel/system/layer/TileSheetData.hx",39,0x2838e1ce)
...
::flixel::system::layer::frames::FlxFrame TileSheetData_obj::getFrame( ::String name){
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","getFrame",0x5af38614,"flixel.system.layer.TileSheetData.getFrame","flixel/system/layer/TileSheetData.hx",51,0x2838e1ce)
	HX_STACK_THIS(this)
...
::flixel::system::layer::frames::FlxSpriteFrames TileSheetData_obj::getSpriteSheetFrames( ::flixel::system::layer::Region region,::flash::geom::Point origin){
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","getSpriteSheetFrames",0x12547407,"flixel.system.layer.TileSheetData.getSpriteSheetFrames","flixel/system/layer/TileSheetData.hx",55,0x2838e1ce)
	HX_STACK_THIS(this)
...
::String TileSheetData_obj::getSpriteSheetFrameKey( ::flash::geom::Rectangle rect,::flash::geom::Point point){
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","getSpriteSheetFrameKey",0xa740c213,"flixel.system.layer.TileSheetData.getSpriteSheetFrameKey","flixel/system/layer/TileSheetData.hx",125,0x2838e1ce)
	HX_STACK_THIS(this)
...
::String TileSheetData_obj::getKeyForSpriteSheetFrames( int width,int height,int startX,int startY,int endX,int endY,int xSpacing,int ySpacing,Float pointX,Float pointY){
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","getKeyForSpriteSheetFrames",0x8c6fd93d,"flixel.system.layer.TileSheetData.getKeyForSpriteSheetFrames","flixel/system/layer/TileSheetData.hx",130,0x2838e1ce)
	HX_STACK_THIS(this)
...
bool TileSheetData_obj::containsSpriteSheetFrames( int width,int height,int startX,int startY,int endX,int endY,int xSpacing,int ySpacing,Float pointX,Float pointY){
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","containsSpriteSheetFrames",0x6b49c384,"flixel.system.layer.TileSheetData.containsSpriteSheetFrames","flixel/system/layer/TileSheetData.hx",134,0x2838e1ce)
	HX_STACK_THIS(this)
	HX_STACK_ARG(width,"width")
	HX_STACK_ARG(height,"height")
	HX_STACK_ARG(startX,"startX")
...
::flixel::system::layer::frames::FlxFrame TileSheetData_obj::addSpriteSheetFrame( ::flash::geom::Rectangle rect,::flash::geom::Point point){
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","addSpriteSheetFrame",0x64739277,"flixel.system.layer.TileSheetData.addSpriteSheetFrame","flixel/system/layer/TileSheetData.hx",143,0x2838e1ce)
	HX_STACK_THIS(this)
	HX_STACK_ARG(rect,"rect")
	HX_STACK_ARG(point,"point")
	HX_STACK_LINE(144)
...
bool TileSheetData_obj::containsFrame( ::String key){
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","containsFrame",0x0c1e4e11,"flixel.system.layer.TileSheetData.containsFrame","flixel/system/layer/TileSheetData.hx",170,0x2838e1ce)
	HX_STACK_THIS(this)
...
int TileSheetData_obj::addTileRect( ::flash::geom::Rectangle tileRect,::flash::geom::Point point){
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","addTileRect",0xd31c4476,"flixel.system.layer.TileSheetData.addTileRect","flixel/system/layer/TileSheetData.hx",176,0x2838e1ce)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.layer.TileSheetData","destroy",0xa631e93d,"flixel.system.layer.TileSheetData.destroy","flixel/system/layer/TileSheetData.hx",181,0x2838e1ce)
		HX_STACK_THIS(this)
		HX_STACK_LINE(182)
		this->bitmap = null();
		HX_STACK_LINE(184)
...
{
		HX_STACK_FRAME("flixel.system.layer.TileSheetData","onContext",0x0267e193,"flixel.system.layer.TileSheetData.onContext","flixel/system/layer/TileSheetData.hx",210,0x2838e1ce)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bitmap,"bitmap")
		HX_STACK_LINE(211)
		this->bitmap = bitmap;
...
int startY = __o_startY.Default(0);
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","getTexturePackerFrames",0xc98e496e,"flixel.system.layer.TileSheetData.getTexturePackerFrames","flixel/system/layer/TileSheetData.hx",222,0x2838e1ce)
	HX_STACK_THIS(this)
...
int startX = __o_startX.Default(0);
int startY = __o_startY.Default(0);
	HX_STACK_FRAME("flixel.system.layer.TileSheetData","addTexturePackerFrame",0x4900dfb0,"flixel.system.layer.TileSheetData.addTexturePackerFrame","flixel/system/layer/TileSheetData.hx",249,0x2838e1ce)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.layer.TileSheetData","destroyFrameBitmapDatas",0x25de80ca,"flixel.system.layer.TileSheetData.destroyFrameBitmapDatas","flixel/system/layer/TileSheetData.hx",283,0x2838e1ce)
		HX_STACK_THIS(this)
		HX_STACK_LINE(284)
