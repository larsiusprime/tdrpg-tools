...
{
HX_STACK_FRAME("flixel.system.layer.RectPointTileID","new",0x7bc9527d,"flixel.system.layer.RectPointTileID.new","flixel/system/layer/TileSheetExt.hx",118,0x9b6b4f03)
...
{
		HX_STACK_FRAME("flixel.system.layer.RectPointTileID","destroy",0xc8838197,"flixel.system.layer.RectPointTileID.destroy","flixel/system/layer/TileSheetExt.hx",125,0x9b6b4f03)
		HX_STACK_THIS(this)
		HX_STACK_LINE(126)
		this->rect = null();
		HX_STACK_LINE(127)
