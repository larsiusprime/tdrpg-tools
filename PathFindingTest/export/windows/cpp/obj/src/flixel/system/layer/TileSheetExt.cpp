...
{
HX_STACK_FRAME("flixel.system.layer.TileSheetExt","new",0x0d1974ec,"flixel.system.layer.TileSheetExt.new","flixel/system/layer/TileSheetExt.hx",19,0x9b6b4f03)
...
{
		HX_STACK_FRAME("flixel.system.layer.TileSheetExt","rebuildFromOld",0x06bd0af6,"flixel.system.layer.TileSheetExt.rebuildFromOld","flixel/system/layer/TileSheetExt.hx",28,0x9b6b4f03)
		HX_STACK_THIS(this)
...
int TileSheetExt_obj::addTileRectID( ::flash::geom::Rectangle rect,::flash::geom::Point point){
	...
	{
		HX_STACK_LINE(79)
		::flixel::system::layer::RectPointTileID value = ::flixel::system::layer::RectPointTileID_obj::__new(tileID,rect,point);		HX_STACK_VAR(value,"value");
		HX_STACK_LINE(79)
...
Void TileSheetExt_obj::destroy( ){
{
		...
		if (((this->tileIDs != null()))){
			HX_STACK_LINE(93)
			for(::cpp::FastIterator_obj< ::flixel::system::layer::RectPointTileID > *__it = ::cpp::CreateFastIterator< ::flixel::system::layer::RectPointTileID >(this->tileIDs->iterator());  __it->hasNext(); ){
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flash::display::BitmapData*/ ,(int)offsetof(TileSheetExt_obj,nmeBitmap),HX_CSTRING("nmeBitmap")},
	{ hx::fsUnknown, 0, null()}
};
#endif
