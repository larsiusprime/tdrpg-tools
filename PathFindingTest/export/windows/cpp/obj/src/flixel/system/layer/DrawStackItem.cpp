...
{
		HX_STACK_FRAME("flixel.system.layer.DrawStackItem","reset",0xd5b5b4ce,"flixel.system.layer.DrawStackItem.reset","flixel/system/layer/DrawStackItem.hx",29,0xaa5e86d2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(30)
		this->graphics = null();
		HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("flixel.system.layer.DrawStackItem","dispose",0x50a9e95e,"flixel.system.layer.DrawStackItem.dispose","flixel/system/layer/DrawStackItem.hx",37,0xaa5e86d2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(38)
		this->graphics = null();
		HX_STACK_LINE(39)
