...
{
HX_STACK_FRAME("flixel.system.debug.LogStyle","new",0xab69ee27,"flixel.system.debug.LogStyle.new","flixel/system/debug/LogStyle.hx",56,0x44adeaa8)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flash::media::Sound*/ ,(int)offsetof(LogStyle_obj,errorSound),HX_CSTRING("errorSound")},
