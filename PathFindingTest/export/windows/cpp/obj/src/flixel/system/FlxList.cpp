...
{
HX_STACK_FRAME("flixel.system.FlxList","new",0x30fa5d95,"flixel.system.FlxList.new","flixel/system/FlxList.hx",33,0x6c72859b)
{
	HX_STACK_LINE(34)
	this->object = null();
	HX_STACK_LINE(35)
...
{
		HX_STACK_FRAME("flixel.system.FlxList","destroy",0xa433f8af,"flixel.system.FlxList.destroy","flixel/system/FlxList.hx",78,0x6c72859b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(80)
		if ((!(this->exists))){
			HX_STACK_LINE(81)
...
::flixel::system::FlxList FlxList_obj::recycle( ){
	HX_STACK_FRAME("flixel.system.FlxList","recycle",0xb739dbc8,"flixel.system.FlxList.recycle","flixel/system/FlxList.hx",44,0x6c72859b)
	HX_STACK_LINE(44)
...
{
		HX_STACK_FRAME("flixel.system.FlxList","clearCache",0x86858ce0,"flixel.system.FlxList.clearCache","flixel/system/FlxList.hx",62,0x6c72859b)
		HX_STACK_LINE(64)
