...
{
HX_STACK_FRAME("flixel.tweens.motion.LinearMotion","new",0x1860e4d1,"flixel.tweens.motion.LinearMotion.new","flixel/tweens/motion/LinearMotion.hx",28,0x15b892fe)
...
bool UseDuration = __o_UseDuration.Default(true);
	HX_STACK_FRAME("flixel.tweens.motion.LinearMotion","setMotion",0x53127aa9,"flixel.tweens.motion.LinearMotion.setMotion","flixel/tweens/motion/LinearMotion.hx",46,0x15b892fe)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.tweens.motion.LinearMotion","update",0xb80e0e38,"flixel.tweens.motion.LinearMotion.update","flixel/tweens/motion/LinearMotion.hx",69,0x15b892fe)
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		this->super::update();
		HX_STACK_LINE(71)
...
Float LinearMotion_obj::get_distance( ){
	HX_STACK_FRAME("flixel.tweens.motion.LinearMotion","get_distance",0xd1a29cad,"flixel.tweens.motion.LinearMotion.get_distance","flixel/tweens/motion/LinearMotion.hx",86,0x15b892fe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(87)
