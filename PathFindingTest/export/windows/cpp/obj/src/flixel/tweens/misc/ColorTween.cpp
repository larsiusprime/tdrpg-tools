...
{
		HX_STACK_FRAME("flixel.tweens.misc.ColorTween","destroy",0x7f5b6002,"flixel.tweens.misc.ColorTween.destroy","flixel/tweens/misc/ColorTween.hx",54,0xe14ed287)
		HX_STACK_THIS(this)
		HX_STACK_LINE(55)
		this->super::destroy();
		HX_STACK_LINE(56)
...
Float ToAlpha = __o_ToAlpha.Default(1);
	HX_STACK_FRAME("flixel.tweens.misc.ColorTween","tween",0xdc858b73,"flixel.tweens.misc.ColorTween.tween","flixel/tweens/misc/ColorTween.hx",72,0xe14ed287)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.tweens.misc.ColorTween","update",0x76358c01,"flixel.tweens.misc.ColorTween.update","flixel/tweens/misc/ColorTween.hx",95,0xe14ed287)
		HX_STACK_THIS(this)
		HX_STACK_LINE(96)
		this->super::update();
		HX_STACK_LINE(97)
