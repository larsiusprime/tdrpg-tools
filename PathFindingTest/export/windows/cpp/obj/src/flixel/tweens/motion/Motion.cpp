...
{
		HX_STACK_FRAME("flixel.tweens.motion.Motion","destroy",0x00e69e26,"flixel.tweens.motion.Motion.destroy","flixel/tweens/motion/Motion.hx",36,0xc6c8a363)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
		this->super::destroy();
		HX_STACK_LINE(38)
...
::flixel::tweens::motion::Motion Motion_obj::setObject( ::flixel::FlxObject object){
	HX_STACK_FRAME("flixel.tweens.motion.Motion","setObject",0x7f27082d,"flixel.tweens.motion.Motion.setObject","flixel/tweens/motion/Motion.hx",42,0xc6c8a363)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.tweens.motion.Motion","update",0xebe25e5d,"flixel.tweens.motion.Motion.update","flixel/tweens/motion/Motion.hx",49,0xc6c8a363)
		HX_STACK_THIS(this)
		HX_STACK_LINE(50)
		this->super::update();
		HX_STACK_LINE(51)
...
{
		HX_STACK_FRAME("flixel.tweens.motion.Motion","postUpdate",0xca0f98dd,"flixel.tweens.motion.Motion.postUpdate","flixel/tweens/motion/Motion.hx",56,0xc6c8a363)
		HX_STACK_THIS(this)
		HX_STACK_LINE(56)
