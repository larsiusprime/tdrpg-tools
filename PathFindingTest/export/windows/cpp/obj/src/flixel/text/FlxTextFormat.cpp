...
{
HX_STACK_FRAME("flixel.text.FlxTextFormat","new",0x67be2279,"flixel.text.FlxTextFormat.new","flixel/text/FlxText.hx",883,0xdf165a6e)
...
{
		HX_STACK_FRAME("flixel.text.FlxTextFormat","destroy",0xc985ff93,"flixel.text.FlxTextFormat.destroy","flixel/text/FlxText.hx",938,0xdf165a6e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(938)
		this->format = null();
	}
