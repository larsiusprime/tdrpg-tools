...
{
HX_STACK_FRAME("flixel.text.pxText._PxBitmapFont.HelperSymbol","new",0xac5d2b4b,"flixel.text.pxText._PxBitmapFont.HelperSymbol.new","flixel/text/pxText/PxBitmapFont.hx",739,0xb7b5754d)
{
}
;
	return null();
