...
::flash::display::BitmapData PxBitmapFont_obj::prepareAngelCodeBitmapData( ::flash::display::BitmapData PxBitmapData,::Xml PxXMLData,Array< ::Dynamic > PxSymbols){
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","prepareAngelCodeBitmapData",0x4f7ef45e,"flixel.text.pxText.PxBitmapFont.prepareAngelCodeBitmapData","flixel/text/pxText/PxBitmapFont.hx",313,0xb7b5754d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(PxBitmapData,"PxBitmapData")
...
{
		HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","dispose",0xf92e4321,"flixel.text.pxText.PxBitmapFont.dispose","flixel/text/pxText/PxBitmapFont.hx",423,0xb7b5754d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(437)
		this->_symbols = null();
		HX_STACK_LINE(438)
...
int PxAdvanceX = __o_PxAdvanceX.Default(0);
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","setGlyph",0x8be1d5e8,"flixel.text.pxText.PxBitmapFont.setGlyph","flixel/text/pxText/PxBitmapFont.hx",492,0xb7b5754d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Tiles,"Tiles")
...
bool PxUseColor = __o_PxUseColor.Default(true);
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","render",0x8a9aef14,"flixel.text.pxText.PxBitmapFont.render","flixel/text/pxText/PxBitmapFont.hx",524,0xb7b5754d)
	HX_STACK_THIS(this)
...
Float PxFontScale = __o_PxFontScale.Default(1);
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","getTextWidth",0x7b8ac8e1,"flixel.text.pxText.PxBitmapFont.getTextWidth","flixel/text/pxText/PxBitmapFont.hx",597,0xb7b5754d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(PxText,"PxText")
	HX_STACK_ARG(PxLetterSpacing,"PxLetterSpacing")
...
int PxBitmapFont_obj::getFontHeight( ){
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","getFontHeight",0xd1978b4e,"flixel.text.pxText.PxBitmapFont.getFontHeight","flixel/text/pxText/PxBitmapFont.hx",640,0xb7b5754d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(640)
...
::flash::display::BitmapData PxBitmapFont_obj::get_pixels( ){
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","get_pixels",0xf34299b4,"flixel.text.pxText.PxBitmapFont.get_pixels","flixel/text/pxText/PxBitmapFont.hx",654,0xb7b5754d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(655)
...
int PxBitmapFont_obj::get_bgTileID( ){
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","get_bgTileID",0xb12d3875,"flixel.text.pxText.PxBitmapFont.get_bgTileID","flixel/text/pxText/PxBitmapFont.hx",666,0xb7b5754d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(666)
...
int PxBitmapFont_obj::get_numLetters( ){
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","get_numLetters",0xa0fcd52e,"flixel.text.pxText.PxBitmapFont.get_numLetters","flixel/text/pxText/PxBitmapFont.hx",675,0xb7b5754d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(675)
...
{
		HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","setCachedGraphics",0x035e0711,"flixel.text.pxText.PxBitmapFont.setCachedGraphics","flixel/text/pxText/PxBitmapFont.hx",680,0xb7b5754d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","store",0x9ccad1e3,"flixel.text.pxText.PxBitmapFont.store","flixel/text/pxText/PxBitmapFont.hx",701,0xb7b5754d)
...
::flixel::text::pxText::PxBitmapFont PxBitmapFont_obj::fetch( ::String PxHandle){
	HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","fetch",0x16aed23c,"flixel.text.pxText.PxBitmapFont.fetch","flixel/text/pxText/PxBitmapFont.hx",711,0xb7b5754d)
	HX_STACK_ARG(PxHandle,"PxHandle")
	HX_STACK_LINE(712)
...
{
		HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","clearStorage",0x290b776c,"flixel.text.pxText.PxBitmapFont.clearStorage","flixel/text/pxText/PxBitmapFont.hx",718,0xb7b5754d)
		HX_STACK_LINE(719)
