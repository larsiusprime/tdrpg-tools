...
class HXCPP_CLASS_ATTRIBUTES  FlxArrayUtil_obj : public hx::Object{
	...
	public:
		...
		static int indexOf_flixel_system_ui_FlxSystemButton( Array< ::Dynamic > array,::flixel::system::ui::FlxSystemButton whatToFind,hx::Null< int >  fromIndex);
		static Dynamic indexOf_flixel_system_ui_FlxSystemButton_dyn();
